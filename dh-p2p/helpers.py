...
# SmartPSS Lite (dolynk) often uses dolynksecurity; dh-p2p upstream defaults to easy4ipcloud.
MAIN_SERVER = "www.easy4ipcloud.com"
MAIN_PORT = 8800
P2P_SERVERS = {
    "easy4ip": ("www.easy4ipcloud.com", 8800),
    "dolynk": ("p2p.dolynksecurity.com", 8800),
}
...
class UDP(socket.socket):
    ...
    def read(self, return_error=False, timeout=90):
